...
if strcmp(env, 'laptop')
    ...
    params.netvlad.dataset.dir = '/Volumes/GoogleDrive/Můj disk/ARTwin/InLocCIIRC_dataset_mirror/NetVLAD';
...
elseif strcmp(env, 'ciirc')
    params.dataset.dir = '/home/lucivpav/InLocCIIRC_dataset_mirror';
